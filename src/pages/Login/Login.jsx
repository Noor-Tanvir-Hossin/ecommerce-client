                ...
                <form className="w-full max-w-md" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mt-6">
                        ...
                        >
                            ...
                            <span className="mx-2" onClick={handleGoogleLogin}>Sign in with Google</span>
                        </a>

                        <div className="mt-6 text-center">
                            <p  className="text-sm text-black ">
                                Don’t have an account yet? <Link to="/register" className='text-lg text-blue-500 hover:underline dark:text-blue-400'>Register</Link>
                            </p>
                        </div>
                    </div>
                </form>
